...
export const enterpriseAccountExecutive: CareerJob = {
  id: "enterprise-account-executive",
  title: "Enterprise Account Executive",
  location: "United Kingdom · Remote",
  summary:
    "Originate, close, and scale complex B2B partnerships with uncapped commission and founder access.",
  blocks: [
    ...
    {
      type: "p",
      text: "We're hiring an Enterprise Account Executive to help us originate, close and scale B2B partnerships across the UK and Europe.",
    },
    {
      type: "p",
