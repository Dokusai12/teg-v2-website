...
export default function CookiesPage() {
  return (
    ...
    >
          ...
          <h2 className="t-h3 mt-10 mb-3">1. What cookies are</h2>
          ...
          <h2 className="t-h3 mt-10 mb-3">2. How we use cookies</h2>
          <p className="t-body mb-3">We use the following types of cookies:</p>
          ...
          <h2 className="t-h3 mt-10 mb-3">3. Consent</h2>
          <p className="t-body mb-6">
          ...
          <h2 className="t-h3 mt-10 mb-3">4. Managing cookies</h2>
          <p className="t-body mb-6">
          ...
          <h2 className="t-h3 mt-10 mb-3">5. Third-party cookies</h2>
          <p className="t-body mb-6">
          ...
          <h2 className="t-h3 mt-10 mb-3">6. Contact</h2>
