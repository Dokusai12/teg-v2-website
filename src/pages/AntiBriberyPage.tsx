...
export default function AntiBriberyPage() {
  return (
    ...
    >
          ...
          <h2 className="t-h3 mt-10 mb-3">1. Scope</h2>
          <p className="t-body mb-6">
            This policy applies to all employees, contractors, and any third parties acting on behalf of Tego Group Limited.
          </p>

          <h2 className="t-h3 mt-10 mb-3">2. Prohibited conduct</h2>
          <p className="t-body mb-3">The following is strictly prohibited:</p>
          ...
          <h2 className="t-h3 mt-10 mb-3">3. Gifts and hospitality</h2>
          <p className="t-body mb-6">
          ...
          <h2 className="t-h3 mt-10 mb-3">4. Reporting concerns</h2>
          <p className="t-body mb-6">
          ...
          <h2 className="t-h3 mt-10 mb-3">5. Compliance and enforcement</h2>
          <p className="t-body mb-6">
          ...
          <h2 className="t-h3 mt-10 mb-3">6. Review</h2>
